...
<template>
    <Glass class="w-full mt-5 p-5 flex-col">
        ...
        <DashboardUser v-if="page == 'user data'"/>
        <DashboardAdmin v-if="page == 'admin user'"/>
        <DashboardItem v-if="page == 'admin item'"/>
        <DashboardStage v-if="page == 'admin stage'"/>
    </Glass>
</template>